...
``src/pose_tools/config/sample_config.py``.

Config / Params split:

* **Config** (``src/pose_tools/config/``) defines only the *shape* of
...
See Also:
    ``SampleConfig`` - the paired config model in ``src/pose_tools/config/``.
...
from pose_tools.config.sample_config import NestedModel
from pose_tools.config.sample_config import SampleConfig
from pose_tools.params.env_type import EnvLocationType
from pose_tools.params.env_type import EnvStageType
from pose_tools.params.env_type import EnvType
from pose_tools.params.env_type import UnknownEnvLocationError
from pose_tools.params.env_type import UnknownEnvStageError
